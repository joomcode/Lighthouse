...
- (void)setupRouter {
    ...
    LHRouteHint *hint = [LHRouteHint hintWithNodes:[NSOrderedSet orderedSetWithObject:hierarchy.greenNode]];
    LHTarget *target = [LHTarget withActiveNode:hierarchy.blueNode routeHint:hint];
